...
/**
 * Componente responsável por renderizar um card individual de serviço
 * Inclui animações, hover effects e interações específicas do card
 */
const ServiceCard: React.FC<ServiceCardProps> = ({ service, index, onContactClick }) => {
